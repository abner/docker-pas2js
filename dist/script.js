...
rtl.module("program",["System","JS","Classes","SysUtils"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"TCrypt",pas.System.TObject,function () {
    this.crypt = function (Src) {
      var Result = "";
      Result = "ENCRYPTED";
      return Result;
    };
  ...
  this.deCrypted = "";
  $mod.$main = function () {
    $mod.cryptObject = $mod.TCrypt.$create("Create");
    $mod.crypted = $mod.cryptObject.crypt("LALALALALA");
    $mod.deCrypted = $mod.cryptObject.decrypt($mod.crypted);
  };
});
rtl.run();
module.exports = pas.program;
